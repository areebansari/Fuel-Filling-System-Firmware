...
int16   ir_rate[5]={0,0,0,0,0};
int16   rate_hundredth=0,rate_tenth=0,rate_ones=0,rate_tens=0,rate_hundred=0;

int1  ltr_selection=FALSE, preset_key=TRUE, full_filling=0, 
      kp_pressed=FALSE, kp_value_flag=FALSE, sign_flag=0, i2c_flag=0;
...
int32 unit_price=0, liters=0, amount=0, kp_rupees=0, kp_liters=0, 
      ...
      calib_value=0,kp_value=0,i2c_data = 0;
