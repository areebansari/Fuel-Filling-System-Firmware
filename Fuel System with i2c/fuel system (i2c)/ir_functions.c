...
//!               min_ltrs_100x = _mul(min_ltrs,100);
               ...
               rate_hundred = 7; rate_tens = 8; rate_ones = 1; rate_tenth = 2; rate_hundredth = 0;
               unit_price =_mul(rate_hundred, 10000) + _mul(rate_tens,1000) + _mul(rate_ones,100) +
...
//!               write_8_bit_values(min_ltrs, _EE_MIN_LTRS);  delay_cycles(4);
               ...
               write_8_bit_values(rate_hundredth, _EE_RATE_HUNDREDTH); delay_cycles(4);
               write_8_bit_values(rate_hundred, _EE_RATE_HUNDRED);
               ...
               while(enter)
               {
                  ...
                  lcd_data[9] = 0x90 | ir_rate[4];
    
                  
                  unit_price = _mul(ir_rate[4],10000) + _mul(ir_rate[3],1000) + _mul(ir_rate[2],100) +
